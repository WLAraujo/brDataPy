...
class OcorrenciasPoliciaisMensal(DatasetTemplate):
    ...
    @staticmethod
    def regioes_disponiveis(self)->dict:
    ...
    def obter_metadados_dataset(self)->dict:
        ...
        Para essa classe são os metadados de obtenção do dataset de ocorrências policiais do estado de São Paulo.
    ...
    def baixar_dataset_csv(self):
        ...
        Para essa classe é um arquivo com o dataset de ocorrências policiais do estado de São Paulo.
        """
    ...
    def obter_dataframe_pandas(self)->pd.DataFrame:
        """Método que retorna os dataset com informações de ocorrências policiais do estado de São Paulo em forma de DataFrame do pandas.
        Para essa classe é um DataFrame com o dataset de ocorrências policiais do estado de São Paulo.
    ...
    def obter_dicionario_python(self)->dict:
        """Método que retorna os dataset com informações de ocorrências policiais do estado de São Paulo em forma de dicionário python.
        Para essa classe é um dicionário com o dataset de ocorrências policiais do estado de São Paulo.
